...
<?php
          ...
          <div class="row">
            <div class="aa-popular-category-area">
              ...
              <div class="tab-content">
                  ...
                  <?php
                 $result = mysqli_query($conn,"SELECT * FROM `product01` WHERE `category`='latest'");
  ...
  <div class="modal fade" id="ln" tabindex="-1" role="dialog" aria-labelledby="myMediulModalLabel">
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#7A1B7A" class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-md btn-danger btn-block" name="user_login">Sign In</button>
          ...
          <div class="modal-dialog modal-sm">
            <div style="color:white;background-color:#7A1B7A" class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button class="btn btn-md btn-danger btn-block" name="register">Sign Up</button>
